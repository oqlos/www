...
- Name: test-user.spec.js >> Dashboard — authenticated >> navigate to Billing from dashboard
- Location: e2e/test-user.spec.js:235:3
...
Call log:
  - waiting for locator('.feature-card').filter({ hasText: 'Manage Plan' })
  ...
  - attempting click action
    ...
    - done scrolling
    - <h4>Devices</h4> from <div class="dash-grid">…</div> subtree intercepts pointer events
