...
- Name: buttons/scenarios-buttons.spec.js >> Scenarios Page Buttons >> terminal run button works
- Location: e2e/buttons/scenarios-buttons.spec.js:29:3
