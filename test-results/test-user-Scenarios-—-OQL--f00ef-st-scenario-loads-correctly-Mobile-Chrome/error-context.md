...
- Name: test-user.spec.js >> Scenarios — OQL >> OQL leak test scenario loads correctly
- Location: e2e/test-user.spec.js:287:3
...
Call log:
  - waiting for locator('.example-tab').filter({ hasText: /Leak|Szczelno/ })
